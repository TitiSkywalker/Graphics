...
public:
	...
	static Vector3f clamp(const Vector3f& v);

	static float dot(const Vector3f& v0, const Vector3f& v1);
	static float clampedDot(const Vector3f& v0, const Vector3f& v1);

	static Vector3f cross(const Vector3f& v0, const Vector3f& v1);
	static Vector3f pointwiseDot(const Vector3f v0, const Vector3f& v1);
